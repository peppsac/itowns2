...
export function updateLayeredMaterialNodeImagery(context, layer, node) {
    ...
    const targetLevel = chooseNextLevelToFetch(layer.updateStrategy.type, zoom, currentLevel, layer);
...
export function updateLayeredMaterialNodeElevation(context, layer, node, force) {
    ...
    const targetLevel = chooseNextLevelToFetch(layer.updateStrategy.type, zoom, currentElevation, layer);
